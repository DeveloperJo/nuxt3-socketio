<template>
	<div class="relative w-full max-w-4xl mx-auto">
		<div
			class="relative flex flex-col-reverse h-[calc(100vh_-_4rem)] overflow-y-auto"
		>
			<div
			...
			>
				<div
					class="inline-flex border rounded-t-lg px-3 py-2"
					:class="
						chat.itsMe
							? 'bg-green-500/10 border-green-500 rounded-bl-xl'
							: 'bg-blue-500/10 border-blue-500 rounded-br-xl'
					"
				>
					{{ chat.content }}
				</div>
